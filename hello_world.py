...
window = pygame.display.set_mode((500, 400), 0, 32)			#creates GUI window
pygame.display.set_caption('Hello world!')

font = pygame.font.SysFont(None, 48)						#None means default system font, 48 is size

text = font.render('Hello world!', True, WHITE, BLUE)		#True to enable anti aliasing
